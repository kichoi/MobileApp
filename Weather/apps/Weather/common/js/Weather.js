...
function dojoInit() {
	require([ "dojo", "dojo/parser", "dojox/mobile", "dojox/mobile/compat", "dojox/mobile/deviceTheme", "dojox/mobile/ScrollableView", "dojox/mobile/EdgeToEdgeList", "dojox/mobile/ListItem", "dojox/mobile/Button","dijit/registry", "dijit/form/DataList", "dojox/mobile/ComboBox", "dojox/mobile/EdgeToEdgeDataList" ],
			function(dojo) {
				dojo.ready(function() {
				});
			});
