...
__WLClient = function() {
    ...
    this.checkResponseForChallenges = function(wlRequest, response, responseForPostAnswersRealm) {
        ...
        if (WL.Client.isWl401(response) || typeof isWl403HandleChallenge == "function" && isWl403HandleChallenge(response)) {
    ...
    this.removeFromWaitingListOnPostAnsweresWlReponse = function (response, wlRequest, responseForPostAnswersRealm){
    	if (this.isWl401(response) || this.isWl403(response) || (typeof isWl403HandleChallenge == "function" && isWl403HandleChallenge(response))){
